            ...
            if update.message:
                ...
                if message_text.lower() == "/start":
                    if chat_id not in load_registered_users():
                        ...
                        bot.send_message(chat_id=chat_id, text="Welcome! You'll be notified of new sales on web3.okx.com.")
                    ...
                    bot.send_message(chat_id=chat_id, text="Script is running smoothly.")
